...
//         overlayColor: MaterialStateProperty.all(Colors.deepPurple.shade100),
//       ),
//     ),
...
//     ),
//     listTileTheme:
//         ListTileThemeData(textColor: Colors.black87, iconColor: primaryColor),
...
//         overlayColor: MaterialStateProperty.all(Colors.amberAccent.shade100),
//       ),
//     ),
//     inputDecorationTheme: InputDecorationTheme(
//       filled: true,
...
//     ),
//     listTileTheme:
//         ListTileThemeData(textColor: Colors.white, iconColor: secondaryColor),
//     dividerTheme: DividerThemeData(color: Colors.grey.shade700, thickness: 1),
//     snackBarTheme: SnackBarThemeData(
//       backgroundColor: Colors.grey[900],
//       contentTextStyle: textTheme.bodyLarge!.copyWith(color: Colors.white),
//     ),
//     drawerTheme: DrawerThemeData(backgroundColor: Colors.black87, elevation: 4),
//   );
// }
...
class AppThemes {
  ...
  static ThemeData themeData(ColorScheme colorScheme, Color focusColor) {
    return ThemeData(
      ...
      drawerTheme:
          DrawerThemeData(backgroundColor: colorScheme.surface, elevation: 4),
    );
  }
